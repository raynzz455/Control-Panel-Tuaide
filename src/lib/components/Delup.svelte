<div class="absolute bottom-0 right-0 h-full w-[22%] pt-8 z-70 flex flex-col items-center justify-center gap-4 bg-gray-500 bg-opacity-40 rounded-tl-lg rounded-bl-lg">    
